...
class Game(object):
	...
	def __init__(self, screen, continuing=False):
		...
		Player.right_images = [load_image_smaller("graphics/walk_2.png", 2), load_image_smaller("graphics/walk_3.png", 2), load_image_smaller("graphics/walk_4.png", 2), load_image_smaller("graphics/walk_5.png", 2), load_image_smaller("graphics/walk_6.png", 2), load_image_smaller("graphics/walk_7.png", 2)]
		...
		Baddie.left_images1 = [load_image_smaller("graphics/steak.png", 6)]
		Baddie.left_images2 = [load_image_smaller("graphics/steak.png", 6)]
		Baddie.left_images3 = [load_image_smaller("graphics/steak.png", 6)]
		Baddie.left_images4 = [load_image_smaller("graphics/steak.png", 6)]
		...
		BaddieBoom.left_images1 = [load_image_smaller("graphics/steak.png", 6), load_image_smaller("graphics/steak.png", 6), load_image("exp1.png"), load_image("exp2.png"), load_image("exp3.png")]
		BaddieBoom.left_images2 = [load_image_smaller("graphics/steak.png", 6), load_image_smaller("graphics/steak.png", 6), load_image("exp1.png"), load_image("exp2.png"), load_image("exp3.png")]
		BaddieBoom.left_images3 = [load_image_smaller("graphics/steak.png", 6), load_image_smaller("graphics/steak.png", 6), load_image("exp1.png"), load_image("exp2.png"), load_image("exp3.png")]
		BaddieBoom.left_images4 = [load_image_smaller("graphics/steak.png", 6), load_image_smaller("graphics/steak.png", 6), load_image("exp1.png"), load_image("exp2.png"), load_image("exp3.png")]
		Coin.images = [load_image_smaller("graphics/apple.png", 8)]
		CoinDie.images = [load_image("exp2-%d.png" % i) for i in range(1, 4)]
		PlayerDie.right_images = [load_image_smaller("graphics/roar_2.png", 2), load_image("exp2-1.png"), load_image("exp2-2.png"), load_image("exp2-3.png")]
		...
		self.heart1 = load_image_smaller("graphics/walk_2.png", 2)
		self.heart2 = load_image("mario-life2.png")
		self.heroimg = load_image_smaller("graphics/walk_3.png", 2)
		...
		if not continuing:
			cutscene(self.screen,
					 ['Long ago,', 
					  ...
					  'A carnivore that embraced',
					  'the herbivore lifestyle'])
			cutscene(self.screen,
					['The other dinosaurs didn\'t',
					 'share Harvey\'s view of the world',
					 'so they shunned him.'
					])
			cutscene(self.screen,
					['Harvey cried and cried,',
					 'but the other raptors didn\'t care'])
			cutscene(self.screen,
					['Nothing seemed to console him.',
	...
	def intro_level(self):
		...
		self.draw_stats()
		ren = self.font.render("THE TREK", 1, (255, 255, 255))
		self.screen.blit(ren, (320-ren.get_width()/2, 255))
		pygame.display.flip()
		pygame.time.wait(2500)
		play_music("song1_dino.ogg")
...
#_______________________________________________________________________
	...
	def draw_stats(self):
		...
		if lives < 0:
			lives = 0
		self.font = pygame.font.Font(filepath("fonts/Jurassic-Park.ttf"), 75)
		ren = self.font.render("Score %d" % self.score, 1, (255, 255, 255))
